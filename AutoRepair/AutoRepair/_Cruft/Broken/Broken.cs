...
namespace AutoRepair {
    public static class Broken {
        ...
        public static readonly Dictionary<ulong, string> mods = new Dictionary<ulong, string>
        {
            ...
            { 1361478243, "* 81 Tiles" },
            { 1575247594, "* 81 Tiles Fixed for 1" },
            { 1560122066, "* 81MOD" },
            { 548208563,  "* 81 Tiles" },
            ...
            { 896806060,  "* Automatic Emptying" },
            { 407873631,  "* Automatic Emptying" },
            { 686588890,  "* Automatic Emptying: Extended" },
            ...
            { 421028969,  "[ARIS] Skylines Overwatch" }, // no replacement
            { 583538182,  "Skylines Overwatch [Fixed for v1.3 +]" }, // no replacement
            { 813833476,  "Skylines Overwatch [1.6]" }, // no replacement
