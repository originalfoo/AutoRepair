namespace Incompatible.Replacements.Scripts
{
    class BulldozeIt : ReplacementBase
    {
        public BulldozeIt()
        {
            ...
            note.Add(3, "The 'Bulldoze It!' and 'Rebuild It!' mods are designed to work together, allowing you to bulldoze some buildings and rebuild others.");

            if (Helper.IsModInstalled(503147777))
            {
